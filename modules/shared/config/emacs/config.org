...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "sunick2009"
    user-mail-address "sunick2009@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/susu/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/susu/bin" "/profile/bin" "/Users/susu/.npm-packages/bin" "/Users/susu/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
